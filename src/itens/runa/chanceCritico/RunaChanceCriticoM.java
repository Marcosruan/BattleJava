...
public class RunaChanceCriticoM extends Item {
	//Atributos para o item
	private final static String nome = "Runa de chance de crítico";
	private final static String descricao = "Uma runa que aumenta a chance de crítico em 30% permanentemente!";
