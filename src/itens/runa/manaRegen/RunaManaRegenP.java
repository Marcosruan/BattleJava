...
public class RunaManaRegenP extends Item {
	//Atributos para o item
	private final static String nome = "Runa pequena de regeneração de mana";
	private final static String descricao = "Uma runa que aumenta a regeneração de mana em 2 permanentemente!";
	...
	private final static int manaRegen = 2;
	
	public RunaManaRegenP() {
		super(nome, 
				  descricao, 
				  raridade, 
				  custo, 
