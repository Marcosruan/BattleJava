...
public class RunaManaRegenG extends Item {
	//Atributos para o item
	private final static String nome = "Runa grande de regeneração de mana";
	private final static String descricao = "Uma runa que aumenta a regeneração de mana em 6 permanentemente!";
	...
	private final static int manaRegen = 6;
	
	public RunaManaRegenG() {
		super(nome, 
				  descricao, 
				  raridade, 
				  custo, 
