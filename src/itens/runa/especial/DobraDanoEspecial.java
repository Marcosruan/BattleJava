...
public class DobraDanoEspecial extends Item{
	//Atributos para o item
	private final static String nome = "Runa do especial";
	private final static String descricao = "Uma runa que dobra o dano do seu especial!";
