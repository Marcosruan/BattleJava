...
public class Critico3x extends Item{
	//Atributos para o item
	private final static String nome = "Runa de critico 3x";
	private final static String descricao = "Uma runa especial que aumenta o fator de crítico para 3!";
