...
public class DobraVida extends Item{
	//Atributos para o item
	private final static String nome = "Runa de vida especial";
	private final static String descricao = "Uma runa especial que dobra a sua vida base!";
