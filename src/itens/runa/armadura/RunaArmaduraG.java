...
public class RunaArmaduraG extends Item {
	//Atributos para o item
	private final static String nome = "Runa grande de armadura";
	private final static String descricao = "Uma runa que aumenta a armadura em 300 permanentemente!";
