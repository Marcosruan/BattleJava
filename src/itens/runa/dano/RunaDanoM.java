...
public class RunaDanoM extends Item {
	//Atributos para o item
	private final static String nome = "Runa de dano";
	private final static String descricao = "Uma runa que aumenta o dano em 150 permanentemente!";
	...
	private final static int dano = 150;
