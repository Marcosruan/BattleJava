...
public class RunaVidaP extends Item{
	//Atributos para o item
	private final static String nome = "Runa pequena de vida";
	private final static String descricao = "Uma runa que aumenta a vida em 100 permanentemente!";
